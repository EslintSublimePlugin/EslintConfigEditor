...
public class Controller implements Initializable {
    ...
    public static final String[] name={"Possible Javascript Errors","Best Javascript Practices","Javascript Variables","Stylistic Javascript","Angular js","Custom JS"};
    public static final String [] path={ "possibleerrors.json","BestPractices.json","variables.json","stylistic.json","angular.json","CustomRules.json"};
        ...
        next.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                if (pageNumber<=path.length-2) {
                    ...
                    }else if (pageNumber==path.length-1){
        ...
        previous.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                if (pageNumber>=1) {
                    ...
                    }else if (pageNumber==path.length-3){
                        ruleMode.setCellFactory(new Callback<TreeTableColumn, TreeTableCell>() {
                            int i=0;
                            @Override
                            public TreeTableCell call(TreeTableColumn param) {
